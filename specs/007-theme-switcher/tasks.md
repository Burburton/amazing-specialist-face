...
|-------|---------|------|--------|------|------|
| 1 | T-001 | 更新 tokens.css 添加 data-theme 选择器 | 🔴 最高 | ⏳ pending | - |
| 1 | T-002 | 创建 useTheme Hook | 🔴 最高 | ⏳ pending | - |
| 2 | T-003 | 创建 ThemeToggle CSS | 🟡 高 | ⏳ pending | - |
| 2 | T-004 | 创建 ThemeToggle Component | 🔴 最高 | ⏳ pending | T-002, T-003 |
| 2 | T-005 | 更新 Header 添加 ThemeToggle | 🔴 最高 | ⏳ pending | T-004 |
| 3 | T-006 | 添加无闪烁初始化脚本 | 🟡 高 | ⏳ pending | - |
| 3 | T-007 | 构建验证 | 🔴 最高 | ⏳ pending | T-005, T-006 |
...
**验收标准**:
- [ ] `[data-theme="light"]` 选择器定义 light mode 变量
- [ ] `[data-theme="dark"]` 选择器定义 dark mode 变量
- [ ] 保留 `@media (prefers-color-scheme: light)` 作为 system fallback
...
**验收标准**:
- [ ] 返回 theme, setTheme, resolvedTheme
- [ ] localStorage 持久化
...
**验收标准**:
- [ ] .trigger 样式 (圆形按钮，hover 效果)
- [ ] .menu 下拉菜单样式
- [ ] .option 选项样式 (active 状态)
- [ ] 遵循 PPT Manual Style
