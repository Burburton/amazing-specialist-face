...
const iconPaths: Record<IconName, React.ReactNode> = {
  ...
  skills: (
    <>
      ...
      <path d="M12 6v1M12 13v1M9 9.5l.87.5M14.13 10.5l.87-.5M9 12.5l.87-.5M14.13 11.5l.87.5" />
    </>
  ),
  roles: (
    <>
  ...
  mvp: <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />,
  m4: (
    <>
